...
# Prepare the results
result = (
    f"Word count in IF.txt file: {word_count1}\n"
    f"Word count in AlwaysRememberUsThisWay.txt file: {word_count2}\n"
    f"Grand total word count of both files: {grand_total_words}\n\n"
    f"Top 3 words in IF.txt file: {top_words_file1}\n"
    f"Top 3 words in AlwaysRememberUsThisWay.txt file: {top_words_file2}\n\n"
